  ...
  en: {
    ...
    rows: [
      ...
      { href: "https://arsalanrc.github.io/rally/", label: "Play a friend, with no server",
        desc: "Send a link, get one back, and the two browsers talk to each other directly" },
    ],
  ...
  de: {
    ...
    rows: [
      ...
      { href: "https://arsalanrc.github.io/rally/", label: "Ohne Server gegeneinander spielen",
        desc: "Einen Link schicken, einen zurückbekommen, dann reden die Browser direkt" },
    ],
