...
const COPY = {
  en: {
    ...
    rows: [
      ...
      { href: "https://arsalanrc.github.io/fanout/", label: "Miss a deadline on purpose",
        desc: "Four suppliers answer at their real speeds, then cut the budget and watch one drop out" },
      { href: "https://arsalanrc.github.io/arena-lounge/", label: "Look inside a Decentraland lounge",
        desc: "Fourteen games at twenty-eight tables, with a walk-through that needs nothing installed" },
      { href: "https://arsalanrc.github.io/siege/", label: "Play a pinball table",
        desc: "Three balls and one castle, with the ball, the flippers and the gravity all worked out from scratch" },
    ],
    workEyebrow: "SELECTED WORK",
    workTitle: "Fourteen repositories, and the newest one is a pinball table",
    howEyebrow: "APPROACH",
  ...
  de: {
    ...
    rows: [
      ...
      { href: "https://arsalanrc.github.io/fanout/?lang=de", label: "Absichtlich eine Frist reißen",
        desc: "Vier Anbieter in ihrem echten Tempo, dann das Budget kürzen und zusehen wie einer rausfällt" },
      { href: "https://arsalanrc.github.io/arena-lounge/", label: "In eine Decentraland-Lounge schauen",
        desc: "Vierzehn Spiele an achtundzwanzig Tischen, mit einem Rundgang ganz ohne Installation" },
      { href: "https://arsalanrc.github.io/siege/", label: "Einen Flipper spielen",
        desc: "Drei Kugeln und eine Burg, und Kugel, Flipper und Schwerkraft sind alle von Hand gerechnet" },
    ],
    workEyebrow: "AUSGEWÄHLTE ARBEITEN",
    workTitle: "Vierzehn Repositories, und das neueste ist ein Flipper",
    howEyebrow: "HALTUNG",
